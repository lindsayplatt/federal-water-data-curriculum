...
The National Water Model (NWM) is produced by NOAA's [Office of Water Prediction](https://water.noaa.gov/about/nwm) (OWP), part of the National Weather Service. NWM is a hydrologic modeling framework, not an observational network — it simulates and forecasts streamflow (along with soil moisture, snowpack, and other water-budget variables) for millions of river reaches across the U.S. by combining weather forecasts, land surface physics, and channel routing. It exists to fill the huge gap between the roughly 8,000 USGS streamgages and the 2.7+ million reaches that make up the U.S. river network, giving forecasters, emergency managers, and floodplain managers guidance in places with no gage at all. Learn more at the [NWM landing page](https://water.noaa.gov/about/nwm) and the [National Water Prediction Service](https://water.noaa.gov/) viewer.
